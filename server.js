...
const PizzaRouter = require("./routes/Pizza.js"); //bring in Pizza Router
const RatRouter = require("./routes/Rat.js"); // bring in Rat Router
...
app.use("/pizza", PizzaRouter); //Connect Router to URL ending in /Pizza
app.use("/Rats", RatRouter); //Connect Router to URL ending in /Rats
